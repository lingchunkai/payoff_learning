...
from security_game_single import SecurityGameOnePaynet 
from experiments import GameDataset, Evaluate
...
def Train(args):
    ...
    net = SecurityGameOnePaynet(int(vsize)-1, 
            S,
            max_val=max_val,
            verify='none', 
...
if __name__  == '__main__':
    print('Old tests removed. Run via Train() instead')
